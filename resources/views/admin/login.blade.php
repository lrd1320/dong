...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" action="{{url('admin/doLogin')}}" class="layui-form" >
            ...
            <hr class="hr15">
            <input name="code" style="width: 150px; float:left;" lay-verify="required" placeholder="验证码"  type="password" class="layui-input">
            <img src="{{url('admin/code')}}" style="float:right; margin-top: 10px;" onclick="this.src='{{url('admin/code')}}?'+Math.random()">
            <hr class="hr15">
